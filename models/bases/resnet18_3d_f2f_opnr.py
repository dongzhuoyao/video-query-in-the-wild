...
class ResNet3D(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(bs):
            ...
            opn = [opn_embed[i:i+1,:,0:20].mean(dim=2),opn_embed[i:i+1,:,20+34:20*2+34].mean(dim=2), opn_embed[i:i+1,:,20*2+34*2:20*3+34*2].mean(dim=2)]
