...
from data_generate.activitynet_label_120_20_60 import (
    arv_train_label,
    arv_test_label,
    arv_val_label,
...
class arv1202060tripletrankbaseline(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        triple = np.concatenate([anchor, positive], axis=0)
        meta["labels"] = [
            self.cls2int[anchor_class_name],
            self.cls2int[anchor_class_name],
        ]
        meta["label_names"] = [anchor_class_name, anchor_class_name]
