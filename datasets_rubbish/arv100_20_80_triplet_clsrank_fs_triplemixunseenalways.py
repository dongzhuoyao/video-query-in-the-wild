...
class arv1002080tripletclsrankfstriplemixunseenalways(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # v3: only mixup in unseen classes
        if anchor_class_name not in arv_train_label:
            anchor, negative = random.sample(
            ...
            triple = np.concatenate(
                [anchor, positive, negative, positive], axis=0
            )
            meta["labels"] = [
