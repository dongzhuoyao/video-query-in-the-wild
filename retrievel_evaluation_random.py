...
class class_map():
    ...
    def mp_add2dict(self, single_query_hit):
        if self.args.memory_leak_debug:  # dongzhuoyao
            for idx, ele in enumerate(single_query_hit):
                single_query_hit[idx]['score'] = random.uniform(0, 1)  # evaluate the random result
...
class ARV_Retrieval_Clip():
    ...
    def ranking(self,):
        ...
        self.class_map_evaluation = class_map(self.args, self.query_list)
        if self.args.debug:
...
class ARV_Retrieval_Untrimmed():
    ...
    def ranking(self,):
        ...
        self.class_map_evaluation05 = class_map(self.args, self.query_list)
        self.class_map_evaluation07 = class_map(self.args, self.query_list)
